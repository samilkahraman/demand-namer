...
const kanatToSheet = (kanatForm) => ({
	...
	yapi: yapiConverter(kanatForm.yapi),
	lambaDerinlik: kanatForm.lambaDerinlik.toLocaleString(),
	lambaGenislik: kanatForm.lambaGenislik.toLocaleString(),
	fitil: kanatForm.fitil,
	pervazKanalGenisligi: kanatForm.pervazKanalGenisligi.toLocaleString(),
	pervazKanalDerinligi: kanatForm.pervazKanalDerinligi.toLocaleString(),
	pervazKanaliAltBosluk: kanatForm.pervazKanaliAltBosluk.toLocaleString(),
	ozelProfilTipi: profilConverter(kanatForm.ozelProfilTipi),
	ozelProfilAciklama: kanatForm.ozelProfilAciklama,
	dumanFitili: booleanToValue(kanatForm.dumanFitili),
	kesim45: booleanToValue(kanatForm.kesim45),
	kilitKarsiligi: booleanToValue(kanatForm.kilitKarsiligi),
	menteseKarsiligi: booleanToValue(kanatForm.menteseKarsiligi),
	hidrolikKarsiligi: booleanToValue(kanatForm.hidrolikKarsiligi),
	soveMi: booleanToValue(kanatForm.soveMi),
